...
def main():
    ...
    testset = 'OTB100'
    # 设置config
    args.config = 'experiments/test/' + testset + '/config.yaml'
    # 设置待测试预训练模型
    args.snapshot = './snapshot/checkpoint_e19.pth'
    # args.snapshot = '../../../RBO-mainfortest/SiamPW-RBOfortest/tools/snapshot/checkpoint_e16.pth'
    # 添加数据集名称
    ...
    dataset_root = '/media/dell/Data/datasets/testing_datasets/' + testset
